...
public class DebugCommands {
    ...
    public DebugCommands() {
        ...
        new CommandAPICommand("stuff:debug")
                .withPermission(stuff.getConfig().getString("DebugCommands.permission"))
                        ...
                        .executes((sender, arguments) -> {
                            ...
                            Bukkit.getServer().getScheduler().runTaskAsynchronously(stuff, () -> {
                                ...
                                if (safeLocation == null) {
                                    ...
                                    String poss = safeLocation.getBlockX() + " " + safeLocation.getBlockY() + " "
                                            + safeLocation.getBlockZ();
                                    sender.sendMessage(
                                            mm.deserialize("<aqua>Safe location found at </aqua><yellow>" + poss
                ...
                .withSubcommand(new CommandAPICommand("listener")
                        ...
                        .executes((executor, args) -> {
                            ...
                            try {
                                ...
                                executor.sendMessage(mm.deserialize("<aqua>Listeners found for \"</aqua><yellow>"
                                        + clazzName + "</yellow><aqua>\":</aqua>"));
                                for (RegisteredListener rl : handlerList.getRegisteredListeners()) {
                                    executor.sendMessage(mm.deserialize("<aqua>-</aqua>"
                                            ...
                                            + "<aqua>with EventPriority:</aqua> <yellow>" + rl.getPriority().name()
                                            + "</yellow>"));
                                }
                            } catch (ClassNotFoundException e) {
                                executor.sendMessage(mm.deserialize(
                                        "<red>Class not found:</red> <yellow>" + e.getMessage() + "</yellow>"));
                            } catch (NoSuchMethodException e) {
                                executor.sendMessage(mm.deserialize(
                                        "<red>Method not found:</red> <yellow>" + e.getMessage() + "</yellow>"));
                            } catch (Exception e) {
                                executor.sendMessage(mm.deserialize(
                                        "<red>An Exception was Thrown:</red> <yellow>" + e.getMessage() + "</yellow>"));
                            }
                        }))
    ...
    static {
        materialInfos.add(mat -> new MaterialInfo("getBlastResistance()",
                mmIfBlock(mat, () -> mmFloat(mat.getBlastResistance()))));
        materialInfos.add(mat -> new MaterialInfo("getEquipmentSlot()",
                mmIfItem(mat, () -> mmString(mat.getEquipmentSlot().toString()))));
        ...
        materialInfos.add(
                mat -> new MaterialInfo("getSlipperiness()", mmIfBlock(mat, () -> mmFloat(mat.getSlipperiness()))));
        ...
        materialInfos
                .add(mat -> new MaterialInfo("isCollidable()", mmIfBlock(mat, () -> mmBoolean(mat.isCollidable()))));
        ...
        materialInfos.add(mat -> new MaterialInfo("stuff.isUnsafeMaterial",
                mmIfBlock(mat, () -> mmBoolean(Teleportation.isUnsafeMaterial(mat)))));
        materialInfos.add(mat -> new MaterialInfo("stuff.isSafeGround",
                mmIfBlock(mat, () -> mmBoolean(Teleportation.isSafeGround(mat)))));
        materialInfos.add(mat -> new MaterialInfo("stuff.isSafeAir",
                mmIfBlock(mat, () -> mmBoolean(Teleportation.isSafeAir(mat)))));
    }
    ...
    private Class<? extends Event> getRegistrationClass(Class<? extends Event> clazz) throws NoSuchMethodException {
        try {
            ...
            if (clazz.getSuperclass() != null
                ...
                throw new NoSuchMethodException("Unable to find handler list for event " + clazz.getName()
